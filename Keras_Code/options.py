...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--fine_tune_optimizer', type=str, default='adamp', help='The fine tuning optimizer')
        ...
        self.parser.add_argument('--start_fine_tune_layer_id', type=int, default=-4, help='The index of start fine tuning layer')
